          ...
          <Reveal>
            <div>
              ...
              <p className="mt-6 max-w-2xl text-lg leading-8 text-pretty text-ivory/80">
                Beds, mattresses, suites, solid pine furniture, and carpets from our Infirmary Road showroom
                with friendly delivery, expert advice and no-pressure showroom support.
              </p>
