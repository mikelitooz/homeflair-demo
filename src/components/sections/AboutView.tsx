  ...
  return (
    <main>
      <PageHero
        ...
        body="Homeflair is a trusted local furniture & carpets retailer with over 50 years of experience, offering quality sofas, leather suites, and rattan garden furniture."
